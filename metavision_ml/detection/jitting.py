...
def export_lightning_model(lightning_model, out_directory, nms_thresh, score_thresh):
    """
    ...
    params['preprocessing_name'] = params.get('preprocess', 'none') # for images, e.g. toy problerm
    ...
    ssd.eval()
    export_ssd(ssd, params, out_directory, nms_thresh, score_thresh)


def export_ssd(ssd, params, out_directory, nms_thresh, score_thresh):
